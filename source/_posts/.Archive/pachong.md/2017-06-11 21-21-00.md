...
- 我使用的Python版本是3.6的，如果大家使用的是2版本，会稍微有点不同，比如print() 方法
...
![要爬取的页面](http://ophmqxrq8.bkt.clouddn.com/0111.png)
...
![要爬取的页面](http://ophmqxrq8.bkt.clouddn.com/009.png)
...
```
到这里我们就写完了我们的爬虫小程序，很简单，后期如果大家有兴趣可以了解一下，当本页图片爬取完后怎么自动爬取下一页的图片，我们也可以一起交流。
